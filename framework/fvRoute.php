...
class fvRoute {
    ...
    {
        echo $currentURLarray = str_replace( "/" , "." , trim( $currentURL , "/" ) );
        
/*
        $formatURLarray  = fvSite::getConfig()->get('formatURL');
        $defaultURLarray = fvSite::getConfig()->get('defaultURL');
        $summaryURLarray = array();
        ...
        if($currentURLarray === ""){
           $summaryURLarray = $defaultURLarray;             
        }else{
            
        }
        
        foreach( $currentURLarray as $target )
        {
            $summaryURLarray =  0;
        }
*/        
...
/*                
    protected function __construct() {
        $this->_routes = fvSite::getConfig()->get('routes');
    }
