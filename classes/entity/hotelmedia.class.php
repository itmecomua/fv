<?php
/**
* Сущность медиа для отеля
* 
*/
class HotelMedia extends Dictionary
{
    ...
    {
        $valid = $this->isNew() || in_array($value,HotelMediaManager::getInstance()->getListMediaType());
    ...
    */    
    ...
    {        
        $tmpDir = HotelMediaManager::getInstance()->getTempImageFolder();
    ...
    */    
    ...
    {
        $web = $web ? "_web" : "";        
        $destPath = fvSite::$fvConfig->get("path.upload.mediahotel{$web}");        
        $folder = $destPath . str_pad($this->hotel_id, 8, 0, STR_PAD_LEFT ) ."/";
    ...
    */
    ...
    {
        return HotelMediaManager::getInstance()->getListMediaType($this->type_id);
    }
    /**
    * Получить тип медиа
    *
