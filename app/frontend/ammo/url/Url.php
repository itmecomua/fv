...
class urlManager{
    ...
    * */
    public function parseUrl( fvRequest $request )
	{
        ...
        $module     = ( isset($route[0]) && $route[0] !=="" )?($route[0]):(fvSite::getConfig()->getSeting('DefaultModuleName'));
        $action     = ( isset($route[1]) && $route[1] !=="" )?($route[1]):(fvSite::getConfig()->getSeting('DefaultActionName'));
