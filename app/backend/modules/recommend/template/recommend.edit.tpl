...
<FORM method="post" action="/backend/{$module}/save/">
    <div class="form" style="padding-top:10px;">
        ...
        <input  type="text" 
                name="m[price]" 
                id="price" 
                value="{$ex->getPrice()|escape}" 
                /><br />
        
        <a href='javascript:void(0);' onclick="javascript:window.doGenerateUrl('url');">
        <p style='font-size: 10px; color:#dddddd; margin-left: 210px; margin-bottom: 3px;'>
            сгенерировать URL по названию.</p>
        </a>
        <label>URL:</label>
            <input  type="text" 
                    name="m[url]" 
