<?php
class PriceOfDayAction extends fvAction
{
    function __construct ()
    {
        parent::__construct(fvSite::$Layoult, PriceOfDayManager::getInstance() );
    }
    ...
    protected function executeSave()
    {
        ...
        try 
        {
            $ex = PriceOfDayManager::getInstance()->getByPk( $id , true);
